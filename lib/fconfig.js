...
(function() {
  ...
  Fconfig = (function() {
    ...
    Fconfig.prototype.parseConfigs = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (k in fc) {
            v = fc[k];
            _results1.push(this.data[k] = this._merge(this.data[this.env_default], v));
          }
          return _results1;
        }).call(this));
      }
    ...
    Fconfig.prototype.get = function(k, env) {
      ...
      if (typeof this.data[env][k] === 'function') {
    ...
    Fconfig.prototype._merge = function(obj1, obj2) {
      var prop;
      for (prop in obj2) {
        try {
          if (obj2[prop].constructor === Object) {
            obj1[prop] = this._merge(obj1[prop], obj2[prop]);
          } else {
            obj1[prop] = obj2[prop];
          }
        } catch (err) {
